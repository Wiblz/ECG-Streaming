...
help:
	...
	@echo "  Development (hot reload enabled by default):"
	@echo "    make docker-build          Build all Docker images"
	@echo "    make docker-up             Start dev services (BLE collector)"
	@echo "    make docker-up-usb         Start dev services (USB collector)"
	@echo "    make docker-up-aggregator  Start aggregator + frontend only"
	@echo ""
	@echo "  Production (optimized builds, no hot reload):"
	@echo "    make docker-prod-build     Build production images"
	@echo "    make docker-prod           Start production (BLE collector)"
	@echo "    make docker-prod-usb       Start production (USB collector)"
