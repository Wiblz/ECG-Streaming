...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'esp_collector.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SENSORTYPE']._serialized_start = 1180
    _globals['_SENSORTYPE']._serialized_end = 1244
    ...
    _globals['_BLENOTIFICATIONDEBUG']._serialized_end = 976
    _globals['_COLLECTORTOESPMESSAGE']._serialized_start = 978
    _globals['_COLLECTORTOESPMESSAGE']._serialized_end = 1056
    _globals['_USBCONFIG']._serialized_start = 1058
    _globals['_USBCONFIG']._serialized_end = 1178