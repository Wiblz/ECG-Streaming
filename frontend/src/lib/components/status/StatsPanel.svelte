  ...
  {#if stats}
    ...
    <dl class="grid grid-cols-2 gap-3">
      ...
      <div class="bg-surface-muted rounded-lg p-4">
        ...
        <dd class="text-xl font-bold text-text">{ecgStats.device_count}</dd>
      </div>
      <div class="bg-surface-muted rounded-lg p-4">
        <dt class="text-xs font-medium text-text-secondary uppercase tracking-wide mb-1">
          ECG Rate
      ...
      <div class="bg-surface-muted rounded-lg p-4">
        <dt class="text-xs font-medium text-text-secondary uppercase tracking-wide mb-1">Buffer</dt>
        <dd class="text-xl font-bold text-text">
    ...
    <div class="mt-5 pt-4 border-t border-border">
      <div class="flex items-center justify-between text-xs">
        <span class="text-text-secondary">Buffer Duration</span>
        <span class="font-medium text-text">{ecgStats.duration_seconds.toFixed(1)}s</span>
      </div>
    </div>
  {:else}
