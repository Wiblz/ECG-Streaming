...
<div class="h-screen overflow-hidden flex flex-col bg-surface">
  ...
  <div
    ...
    class="flex-1 overflow-hidden bg-linear-to-br from-surface-muted to-surface flex flex-col relative"
  >
    ...
    <!-- Control panel -->
    <div class="w-full max-w-4xl mx-auto p-6 bg-surface border-t border-border shadow-lg">
      <div class="space-y-6">
        <!-- Main controls -->
        ...
        <!-- Delay pattern input -->
        <div class="space-y-2">
          <label for="delay-pattern" class="block text-sm font-medium text-text-secondary">
          ...
          <div class="flex gap-2">
            <input
              ...
              class="flex-1 px-4 py-2 bg-surface text-text border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-focus"
            />
